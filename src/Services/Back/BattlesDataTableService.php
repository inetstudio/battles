...
use InetStudio\Battles\Contracts\Services\Back\BattlesDataTableServiceContract;

/**
 * Class BattlesDataTableService.
 */
class BattlesDataTableService extends DataTable implements BattlesDataTableServiceContract
{
    /**
     * @var
     */
    ...
    /**
     * BattlesDataTableService constructor.
     */
    ...
    {
        $transformer = app()->make('InetStudio\Battles\Contracts\Transformers\Back\BattleTransformerContract');
