...
namespace InetStudio\Battles\Console\Commands;
...
class SetupCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'inetstudio:battles:setup';
    ...
    private function initCommands(): void
    {
        $this->calls = [
            [
                ...
                'params' => [
                    '--provider' => 'InetStudio\Battles\Providers\BattlesServiceProvider',
                    '--tag' => 'migrations',
                ],
            ],
            [
            ...
            [
                ...
                'command' => 'inetstudio:battles:folders',
            ],
            [
                'type' => 'artisan',
