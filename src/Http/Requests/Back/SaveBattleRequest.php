...
namespace InetStudio\Battles\Http\Requests\Back;
...
/**
 * Class SaveBattleRequest.
 */
class SaveBattleRequest extends FormRequest implements SaveBattleRequestContract
{
    /**
    ...
    public function rules(Request $request): array
    {
        ...
        return array_merge([
            ...
            'slug' => 'required|alpha_dash|max:255|unique:battles,slug,'.$request->get('battle_id'),
